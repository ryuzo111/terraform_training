...
# RDS subnet group 
# ---------------------------
resource "aws_db_subnet_group" "mysql_standlone_subnetgroup" {
...
resource "aws_db_instance" "mysql_standalone" {
  ...
  db_subnet_group_name   = aws_db_subnet_group.mysql_standlone_subnetgroup.name
